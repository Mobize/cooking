...
--
-- Client :  127.0.0.1
-- Généré le :  Sam 21 Mai 2016 à 14:54
...
--
CREATE DATABASE IF NOT EXISTS `cooking` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `cooking`;
